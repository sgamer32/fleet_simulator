...
# ==============================================================================
st.set_page_config(
    page_title="Locater | Real-Time India Fleet & Delivery Simulator (v3)",
    page_icon="🇮🇳",
    layout="wide",
...
# HEADER & CONTROL BAR
# ==============================================================================
st.markdown('<div class="main-header">🇮🇳 Locater | Real-Time India Fleet Simulator</div>', unsafe_allow_html=True)
...
with tele_col:
    st.subheader("📊 Fleet Telemetry (India)")
...
with tab_logs:
    st.subheader("⚡ Automated Re-Routing Event Ledger (India)")
